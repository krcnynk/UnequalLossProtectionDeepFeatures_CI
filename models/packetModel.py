...
class PacketModel(object):
    ...
    def dataToPacket(self):
        ...
        if self.data_shape[1]%self.rows_per_packet ==0: #! Fully divisible data by x rows.
        ...
        self.numZeros = self.rows_per_packet - (self.data_shape[1]%self.rows_per_packet) #! Append zeros
